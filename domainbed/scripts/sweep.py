...
class Job:
    ...
    @staticmethod
    def launch(jobs, launcher_fn, gpu_ids):
        print('Launching...')
        jobs = jobs.copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_env', type=int, nargs='+', default=[0])
    ...
    if args.command == 'launch':
        ...
        Job.launch(to_launch, launcher_fn, gpu_ids)
